...
#[test]
fn test_contribute_under_balance_returns_insufficient_funds_without_failure_event() {
    let env = Env::default();
    env.mock_all_auths();
