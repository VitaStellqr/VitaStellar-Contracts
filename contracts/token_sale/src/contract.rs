...
impl TokenSaleContract {
    ...
    fn apply_contribution(
        ...
        contribution.tokens_allocated = contribution
            .tokens_allocatedhttps://github.com/VitaStellqr/VitaStellar-Contracts/pull/119/conflict?name=contracts%252Ftoken_sale%252Fsrc%252Fcontract.rs&ancestor_oid=f65ec13e1306255172f084543d1d7777766ae895&base_oid=dacf00aa57119383da750ce2f22675763c1b431a&head_oid=8b6d5a99789bb9f6983bce4edd955025dbaf1576
            .checked_add(tokens_to_allocate)
            .ok_or(Error::Overflow)?;
